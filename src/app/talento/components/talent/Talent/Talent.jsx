  ...
  return (
    <Container>
      ...
      <div className={`flexContainer`}>
        <Menu
          menuButton={
            <MenuButton className={`${styles.buttonMenu} boxShadow borderRadius`}>
              <span>Menú</span> <IoIosArrowDown />
            </MenuButton>
          }
          transition
        >
      ...
      <GridContainer>
        {talent.filter((talent) => talent.location === location).map((talent, i) => (
          <Slide key={i} triggerOnce>
            <div
